        ...
        <>
            <div className="about-us-wrapper">
                ...
                <div className="season-goal-section">
                    <h1 className='about-h1'>THIS SEASON'S GOAL</h1>
                    <p>Our primary objective for this season is to complete the manufacturing and testing of our first solar car and successfully participate in our debut international competition in Belgium this September.</p><br />
                ...
                <div className="how-competition-works-section">
                    <h1 className='about-h1'>HOW THE COMPETITION WORKS</h1>
                    ...
                    <div className="stage-section">
                        <h2 className='about-h2'>STATIC SCRUTINEERING</h2>
                    ...
                    <div className="stage-section">
                        <h2 className='about-h2'>24-HOUR ENDURANCE RACE</h2>
